      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            hint: "Live verify. Why stars are not a bulletin.",
          },
        ],
      },
      {
...
GET  /api/trades/{id}/messages`,
  ...
  reputacion: {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "The **public** profile does not show a star bulletin (who rated you, exact average). That graph would re-cluster Bitcoin keys. The market sees a **ZK badge** that this browser re-verifies. You still see your own average privately. Live demo and BitVM drawings: `/docs/zk`.",
      },
    ],
  },
  api: {
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            hint: "Verificación en vivo. Por qué las estrellas no son un boletín.",
          },
        ],
      },
      {
...
GET  /api/trades/{id}/messages`,
  ...
  reputacion: {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "El perfil **público** no muestra un boletín de estrellas (quién te valoró, promedio exacto). Ese grafo volvería a clusterizar claves Bitcoin. El mercado ve un **badge ZK** que este navegador vuelve a verificar. Tú sí ves tu promedio en privado. Demo en vivo y dibujos BitVM: `/docs/zk`.",
      },
    ],
  },
  api: {
